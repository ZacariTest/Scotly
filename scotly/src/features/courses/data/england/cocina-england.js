  ...
  steps: [
    ...
    },
    {
      ...
      body: [
        ...
        "El **afternoon tea.** Té servido entre las 3 y las 5 de la tarde con sándwiches de pepino, scones con crema y mermelada, y pequeños pasteles, fue creado por Anna, duquesa de Bedford, en la década de 1840. El **cream tea** de Cornwall y Devon, donde el debate sobre si la crema va antes o después de la mermelada en el scone, es una disputa regional que se toma con seriedad.",
      ],
    },
    {
      type: "quiz",
    ...
    },
    {
      ...
      img: "/img/C5.jpg",
      body: [
        "El **pub** (public house) es una institución social que existe desde la época romana. Los **ale houses** medievales evolucionaron en el espacio donde se resuelven disputas, se celebran victorias deportivas, se hacen negocios y se construyen comunidades. Hay aproximadamente **47.000 pubs** en el Reino Unido.",
