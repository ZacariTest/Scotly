export const course = {
  ...
  steps: [
    ...
    },
    {
      type: "quiz",
      label: "Quiz I",
      question: "¿Qué escritor del siglo XII popularizó la leyenda del rey Arturo en su «Historia de los Reyes de Britania»?",
      options: [
        "Chaucer",
    ...
    },
    {
      type: "quiz",
      label: "Quiz II",
      question: "¿Quién atrapa a Merlín en la versión más conocida de la leyenda artúrica?",
      options: [
        "La reina Ginebra",
        "El hada Morgana",
    ...
    },
    {
      type: "quiz",
      label: "Quiz III",
      question: "¿Qué simboliza el diseño circular de la Mesa Redonda en la leyenda artúrica?",
      options: [
        "La eternidad del reino de Camelot",
        "La igualdad en honor entre todos los caballeros",
    ...
    },
    {
      type: "quiz",
      label: "Final",
      question: "¿Qué escritor del siglo XX reescribió la leyenda artúrica en «The Once and Future King»?",
      options: [
        "C.S. Lewis",
        "J.R.R. Tolkien",
        "T.H. White",
