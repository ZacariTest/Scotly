...
// ── Tema por defecto ─────────────────────────────────────────
const REGION_THEMES = {
  scotland: { "--region-primary":"#0b1f17","--region-accent":"#4a9a60","--region-border":"#1e3d2a","--region-surface":"rgba(74,154,96,0.07)","--region-text":"#e8f4ec","--region-muted":"#6a9a7a","--region-btn":"#4a9a60","--color-primary":"#0b1f17", bgImage:"url('/img/bg-scotland.png')" },
...
ReactDOM.createRoot(rootEl).render(   // ← usamos rootEl que ya tenemos
  <React.StrictMode>
    <BrowserRouter>
      <App />
    </BrowserRouter>
