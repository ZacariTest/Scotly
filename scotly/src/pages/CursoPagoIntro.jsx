...
export default function CursoPagoIntro() {
    ...
    const comprar = async () => {
        ...
        try {
            ...
            mostrarMensaje(
                `¡Curso desbloqueado! +${data.recompensa.carta}, +${data.recompensa.monedas} monedas, +${data.recompensa.puntos} provisiones`,
                "ok"
            );
        } catch (err) {
                ...
                <div className="curso-pago-content">
                    ...
                    {acceso ? (
                        ...
                        <div className="curso-pago-paywall">
                            {curso.recompensa && (
                                <div className="curso-pago-recompensa">
                                    <p className="curso-pago-recompensa__label">Incluye</p>
                                    <div className="curso-pago-recompensa__items">
                                        {curso.recompensa.carta && (
                                            <span className="curso-pago-recompensa__item">
                                                {RAREZA_ICONO[curso.recompensa.carta.rareza] || "🎴"} Carta{" "}
                                                {curso.recompensa.carta.nombre} | {RAREZA_LABEL[curso.recompensa.carta.rareza] || ""}
                                            </span>
                                        )}
                                        <span className="curso-pago-recompensa__item">
                                            🪙 {curso.recompensa.monedas} monedas
                                        </span>
                                        <span className="curso-pago-recompensa__item">
                                            📜 {curso.recompensa.puntos} provisiones
                                        </span>
                                    </div>
                                </div>
                            )}
